...
import org.vaadin.tatu.TwinColSelect.SortMode;
...
@Route("big")
public class BigDataView extends VerticalLayout {
    int newi = 1;
    ...
    public BigDataView() {
        ...
        select.setSortMode(SortMode.FAST);
        ...
        buttons1.add(refresh, clear, clearTicks, readOnly);
        HorizontalLayout buttons2 = new HorizontalLayout();
        buttons2.add(pickMode, variants, styled);
